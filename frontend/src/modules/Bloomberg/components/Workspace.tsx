...
import TradeGeneratorScreen from '../screens/TradeGeneratorScreen';
...
import FailedTradesScreen from '../screens/FailedTradesScreen';
...
export default function Workspace({ state }: WorkspaceProps) {
  const renderScreen = () => {
    switch (state.screen) {
      ...
      case 'FAIL':
        return <FailedTradesScreen parameter={state.parameter} />;
      case 'QUEUE':
